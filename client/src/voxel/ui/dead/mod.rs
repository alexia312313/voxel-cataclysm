...
use super::end::updates::{interact_with_quit_button, update_score_text_final, update_time_final};
...
impl Plugin for DeadPlugin {
    fn build(&self, app: &mut App) {
        app.add_system(spawn_dead_screen.in_schedule(OnEnter(GameState::Dead)))
            .add_systems(
                (
                    ...
                    .in_set(OnUpdate(GameState::Dead)),
            )
